...
AO[1] = c_ab * AB[1] + c_ad * AD[1] (eq. 1),
AO[2] = c_ab * AB[2] + c_ad * AD[2] (eq. 2).

One may note that AB[1] * (eq. 2) - AB[2] * (eq. 1) implies that
...
Similarly, AD[1] * (eq. 2) - AD[2] * (eq. 1) implies that
...
AO[1] = c_ab * AB[1] + c_ac * AC[1] (eq. 1),
AO[2] = c_ab * AB[2] + c_ac * AC[2] (eq. 2).
...
Similarly, AC[1] * (eq. 2) - AC[2] * (eq. 1) implies that
